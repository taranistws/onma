...
class Menu extends CI_Controller
{
    ...
    public function menutype(){
             $cms_pages=$this->app_model->getAllList('cms_pages',null,'id','DESC');
...
<select name="url" class="form-control" required >
      <option value="">Select Page</option> 
                       <?php 
                        foreach($cms_pages as $cms_pages1) { ?>
                  <option value="<?php echo  $cms_pages1['slug']; ?>"><?php echo $cms_pages1['name']; ?></option>
                       <?php } ?>
...
$data['cms_pages']=$this->app_model->getAllList('cms_pages',null,'id','DESC');
...
//                        $d['klass'] = $data['class']; //klass instead of class because of an error in js
    ...
    {
        $this->load->view('admin/menu/sample');
    }

    public function vertical_sample($category='')
    {
        $this->load->view('admin/menu/vertical_menu_sample');
    }

    public function test($category='')
    {
        $this->load->view('admin/menu/test');
    }
}
