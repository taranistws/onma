        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>patner"><i class="fas fa-fast-backward"></i> Back</a></li>
...
//print_R($patner);
       ...
       ?>
              <form role="form" action="<?= base_url()?>patner/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
    ...
    <div class="form-group">
                    ...
                    <input type="text" name="link" class="form-control" id="" value="<?= $patner['link']?>" placeholder="Enter Link">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                           ...
                           <?php } else { ?>
                       <img class="show_image" src="<?= $patner['image']; ?>" width="100" height="100">
                           <?php } ?>
