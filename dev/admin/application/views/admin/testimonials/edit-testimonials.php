        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>testimonials"><i class="fas fa-fast-backward"></i> Back</a></li>
...
//print_R($testimonials);
       ...
       ?>
              <form role="form" action="<?= base_url()?>testimonials/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Name</label>
                         <input type="text" name="title" class="form-control" id="" value="<?= $testimonials['title']?>" placeholder="Name">
                      </div>
                   ...
                   <textarea name="description" style="width: 100%;"> <?= $testimonials['description']?></textarea>
                    <span><?= form_error('description')?></span>
              </div>

    <div class="form-group">
                    <label for="link"> Link</label>
                    <input type="text" name="link" class="form-control" id="" value="<?= $testimonials['link']?>" placeholder="Enter Link">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                            if ($testimonials['image']=='') { ?>
                                  <img class="show_image" src="<?= base_url(); ?>public/assets/dist/img/avatar5.png" width="100" />
                           <?php } else { ?>
                       <img class="show_image" src="<?= $testimonials['image']; ?>" width="100" height="100">
                           <?php } ?>
