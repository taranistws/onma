...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>category/add"><i class="fas fa-plus"> </i> Add</a></li>
 ...
 <?php if(!empty($row['images'])) { ?> 
                    <img src="<?= $row['images']; ?>" alt="" style="width:100px;" />
...
$('.cls_priority').change(function(){
  ...
  val = $(this).val(); 
   $.ajax({
      url:'<?= base_url()?>category/priority',
      type:'POST',
