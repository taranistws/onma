                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="name" class="form-control" id="" value="<?= $category['name']?>" placeholder="Enter Name" required="" >
                      </div>
   </div>
    ...
    <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                          <?php
                            if ($category['images']!='') { ?>
                              <img class="show_image" src="<?= $category['images']?>" width="100" height="100">
                           <?php } else { ?>
