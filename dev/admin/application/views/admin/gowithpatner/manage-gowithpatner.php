  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>gowithpatner List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
          <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>gowithpatner/add"><i class="fas fa-plus"></i> Add New</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <th>Link</th>
                ...
                <tr>
                 ...
                 <img src="<?= $row['image'];?>"  style="width:100px; height:100px;"/></td>
                  ...
                  <a href="<?= base_url()?>gowithpatner/edit/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs"><i class="fas fa-pencil-alt"></i></a>
                   <?php
                      if ($row['status']==0) { ?>
...
function deletes(){
   ...
   window.location.href='<?= base_url()?>gowithpatner/delete/'+deleteId;
}

function status(status,id){
   window.location.href='<?= base_url()?>gowithpatner/status/'+status+'/'+id;
}
