  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>gowithpatner  Edit</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>gowithpatner"><i class="fas fa-fast-backward"></i> Back</a></li>
...
//print_R($gowithpatner);

       ?>
              <form role="form" action="<?= base_url()?>gowithpatner/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
             ...
             <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="" value="<?= $gowithpatner['title']?>" placeholder="Enter title">
    ...
    <div class="form-group">
                    ...
                    <input type="text" name="link" class="form-control" id="" value="<?= $gowithpatner['link']?>" placeholder="Enter Link">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                            if ($gowithpatner['image']=='') { ?>
                                  <img class="show_image" src="<?= base_url(); ?>public/assets/dist/img/avatar5.png" width="100" />
                           <?php } else { ?>
                       <img class="show_image" src="<?= $gowithpatner['image']; ?>" width="100" height="100">
                           <?php } ?>
