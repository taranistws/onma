  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CMS Pages List Edit</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>cms"><i class="fas fa-fast-backward"></i> Back</a></li>
    ...
    <section class="content">
     <div class="row">
          ...
          <div class="col-md-12">
			...
			?>
              <form role="form" action="<?= base_url()?>cms/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1"> Page Name*</label>
                         <input type="text" name="name" class="form-control" id="" value="<?= $cms['name']?>" placeholder="Page Name">
                      </div>
                    ...
                    <textarea  id="textarea" class="textarea"  name="description" class="form-control" id="" row="6" value="" > <?= $cms['description']?> </textarea>
               ...
               <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                           ...
                           <?php } else { ?>
                       <img class="show_image" src="<?= $cms['image']; ?>" width="100" height="100">
                           <?php } ?>
                    ...
                    <textarea  class="textarea"  name="meta_title" class="form-control" id="" value="" style="width:100%;"> <?= $cms['meta_title']?>   </textarea>
                    ...
                    <textarea class="textarea"  name="meta_tags" class="form-control" id="" value="" style="width:100%;" >  <?= $cms['meta_tags']?> </textarea>
                    <span><?= form_error('meta_tags')?></span>
				      </div> 
				      
				       <div class="form-group">
                    <label for="exampleInputEmail1"> Meta description</label>
                    <textarea class="textarea"   name="meta_description" class="form-control" id="" value="" style="width:100%;" > <?= $cms['meta_description']?>  </textarea>
