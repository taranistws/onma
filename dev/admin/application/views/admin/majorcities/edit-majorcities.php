                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" name="file" class="custom-file-input" id="thumb_image">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                           ...
                           <?php } else { ?>
                       <img class="show_image" src="<?= $SITE_URL; ?>api/assets/images/hall/<?= $category['image']; ?>" width="100" height="100">
                           <?php } ?>
