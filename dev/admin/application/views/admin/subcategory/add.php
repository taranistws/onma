        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>admin/subcategory"><i class="fas fa-fast-backward"></i> Back</a></li>
     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
 <form role="form" action="<?= base_url()?>admin/subcategory/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="name" class="form-control" id="" value="" placeholder="Enter Name" required="">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="slug" class="form-control" id="" value="" placeholder="Enter slug" required="" >
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" name="files[]" class="custom-file-input" id="images" multiple>
