    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>blogs/add"><i class="fas fa-plus"></i> Add New</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All blogs Pages List List Display Here</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap;">
                            ...
                            <a href="<?= base_url()?>blogs/edit/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs"><i class="fas fa-pencil-alt"></i></a>
...
function deletes(){
   ...
   window.location.href='<?= base_url()?>blogs/delete/'+deleteId;
}

function status(status,id){
   window.location.href='<?= base_url()?>blogs/status/'+status+'/'+id;
}
