  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>blogs Pages List Edit</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>blogs"><i class="fas fa-fast-backward"></i> Back</a></li>
    ...
    <section class="content">
     <div class="row">
          ...
          <div class="col-md-12">
			...
			?>
              <form role="form" action="<?= base_url()?>blogs/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="name" class="form-control" id="" value="<?= $blogs['name']?>" placeholder="Page Name">
                      </div>
                    ...
                    <textarea  id="textarea" class="textarea"  name="description" class="form-control" id="" row="6" value="" > <?= $blogs['description']?> </textarea>
               ...
               <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                            if ($blogs['image']=='') { ?>
                                  <img class="show_image" src="<?= $SITE_URL; ?>public/assets/dist/img/avatar5.png" width="100" />
                           <?php } else { ?>
                       <img class="show_image" src="<?= $blogs['image']; ?>" width="100" height="100">
                           <?php } ?>
                    ...
                    <textarea  class="textarea"  name="meta_title" class="form-control" id="" value="" style="width:100%;"> <?= $blogs['meta_title']?>   </textarea>
                    <span><?= form_error('meta_title')?></span>
				      </div> 
				      
				      
				         <div class="form-group">
                    <label for="exampleInputEmail1"> Meta tags</label>
                    <textarea class="textarea"  name="meta_tags" class="form-control" id="" value="" style="width:100%;" >  <?= $blogs['meta_tags']?> </textarea>
                    <span><?= form_error('meta_tags')?></span>
				      </div> 
				      
				       <div class="form-group">
                    <label for="exampleInputEmail1"> Meta description</label>
                    <textarea class="textarea"   name="meta_description" class="form-control" id="" value="" style="width:100%;" > <?= $blogs['meta_description']?>  </textarea>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-center">Are You Want To Sure Delete blogs Pages List ?</p>
      </div>
...
$catdata=explode(',',$blogs['category']);
