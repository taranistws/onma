    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>widgets/add"><i class="fas fa-plus"></i> Add New</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php } ?>
                  ...
                  <a href="<?= base_url()?>widgets/edit/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs"><i class="fas fa-pencil-alt"></i></a>
                   <?php
                      if ($row['status']==0) { ?>
...
function deletes(){
   ...
   window.location.href='<?= base_url()?>widgets/delete/'+deleteId;
}

function status(status,id){
   window.location.href='<?= base_url()?>widgets/status/'+status+'/'+id;
}
