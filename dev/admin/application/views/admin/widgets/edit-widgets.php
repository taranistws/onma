        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>widgets"><i class="fas fa-fast-backward"></i> Back</a></li>
...
//print_R($widgets);
       ...
       ?>
              <form role="form" action="<?= base_url()?>widgets/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Name</label>
                         <input type="text" name="title" class="form-control" id="" value="<?= $widgets['title']?>" placeholder="Name">
                      </div>
                   ...
                   <textarea name="description" class="textarea"> <?= $widgets['description']?></textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                        ...
                        <?php
                           ...
                           <?php } else { ?>
                       <img class="show_image" src="<?= $widgets['image']; ?>" width="100" height="100">
                           <?php } ?>
