     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              ...
              <form role="form" action="<?= base_url()?>projects/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="" value="" placeholder="Page  name">
                  ...
                  <div class="form-group">
                    ...
                    <textarea  id="textarea" class="textarea"  name="description" class="form-control" row="6" id="" value="" >   </textarea>
      ...
      <div class="col-sm-12 pull-right" style="text-align: right;margin-bottom: 10px;">
             ...
             <br/><br/>
                    ...
                    <textarea   class="textarea" name="meta_title" class="form-control" id="" value="" style="width:100%;">   </textarea>
                    ...
                    <textarea   class="textarea" name="meta_tags" class="form-control" id="" value="" style="width:100%;">   </textarea>
                    <span><?= form_error('meta_tags')?></span>
				      </div> 
				      
				       <div class="form-group">
                    <label for="exampleInputEmail1"> Meta description</label>
                    <textarea   class="textarea" name="meta_description" class="form-control" id="" value="" style="width:100%;" >   </textarea>
